...
Saiku.i18n = {
    locale: ('cn' || navigator.language || navigator.browserLanguage ||
	...
	$.fn.i18n = function(po_file) {
		...
		return $.each(this, function() {
            ...
            if (element.attr('placeholder')) {
                translated_value = translate( element.attr('placeholder'), po_file );
                if (Saiku.i18n.elements.indexOf &&
                    Saiku.i18n.elements.indexOf(element.attr('placeholder')) === -1) {
                    Saiku.i18n.elements.push(element.attr('placeholder'));
                }
                if (translated_value) {
                    element.data('original', element.attr('placeholder'));
                    element.attr({ 'placeholder': translated_value });
                    element.removeClass('i18n');
                }
            }
