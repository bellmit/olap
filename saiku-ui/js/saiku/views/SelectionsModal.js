...
var SelectionsModal = Modal.extend({
    ...
    buttons: [
        ...
        { text: "Open Date Filter", method: "open_date_filter" ,class:"yhnsave"},
    ...
    post_render: function(args) {
        ...
        var width = $(window).width() < 958 ? $(window).width() :958;
        $(args.modal.el).parents('.ui-dialog')
            .css({ width: width, left: "inherit", margin:"0", height: 667 })
            .offset({ left: left});
    ...
    save: function() {
        ...
        if ($(this.el).find('.used_selections input').length === 0) {
            ...
            // Loop through selections  这部分会将过滤框内容遍历
        ...
        self.workspace.query.helper.displayAllSelections();
