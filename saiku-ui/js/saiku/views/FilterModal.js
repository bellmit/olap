...
var FilterModal = Modal.extend({
    ...
    expression_text: function() {
        var c = "<form id='custom_filter'><table style='display: block;overflow: hidden;'>";
        if (this.expressionType == "Order") {
            c += "<tr style='    width: calc(100% + 28px);overflow: hidden;display: inline-block;margin-left: -10px;'><td >排序类型</td><td><select id='fun'><option>ASC</option><option>BASC</option><option>DESC</option><option>BDESC</option></select></td></tr>";
        }
        c += "<tr><td class='col1 i18n'>" + this.expressionType + " MDX Expression:</td></tr>" +
