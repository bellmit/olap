...
var OpenDialog = Modal.extend({
    ...
    buttons: [
        { id: "test", text: "Open", method: "open_query" ,class:"yhnsave"},
    ...
    initialize: function(args) {
        ...
        var self = this;
        var name = "";
        this.message =  "<br/><b><div class='query_name'><span class='i18n'>Please select a file.....</span></div></b><br/><div class='RepositoryObjects i18n'>Loading....</div>" +
                        "<br>" +
                        '<div style="height:25px; line-height:25px;"><b><span class="i18n">Search:</span></b> &nbsp;' +
                        ' <span class="search"><input type="text" class="search_file"><span class="cancel_search"></span></span></div>';
